...
<select name="cust_healthstatus" class="form-control" required>
  ...
  <option value="Non Medical Needs">Non Medical Needs</option>
				...
				<div class="form-group">							  <label>Staff Number</label>
					...
					AD/R/S.<input type="text" onkeyup="this.value = this.value.toUpperCase();" pattern="[0-9].{3}" maxlength="4" class="form-control" name="cust_staffid" id="lname" placeholder="<?php if (@$cust_staffid <> ""){echo substr("@$cust_staffid",-4);} else {echo "Enter Last 4 digit of your staff number";}?>" value="<?php echo substr("@$cust_staffid",-4); ?>"  />
				</div>
